...
If you're reading this workflow because an orchestrator spawned you (vs running directly from @[execute-plan.md]), the orchestrator's prompt will include checkpoint return instructions. Follow those instructions when you hit a checkpoint.
...
`@[execute-plan.md] .planning/phases/{phase-dir}/{phase}-{next-plan}-PLAN.md`
...
- `@[research-phase.md] {Z+1}` — investigate unknowns
