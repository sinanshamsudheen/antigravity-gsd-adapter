...
- NOT for scope creep or "nice to haves" (capture with @[add-todo.md] instead)
...
Decimal phases added later via @[insert-phase.md] command (if it exists).
...
**Also available:**
- `@[discuss-phase.md] 1` — gather context first
- `@[research-phase.md] 1` — investigate unknowns
- Review roadmap
