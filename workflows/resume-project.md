...
→ Primary: Resume interrupted agent (@[resume-task.md])
...
1. Resume interrupted agent (@[resume-task.md]) [if interrupted agent found]
   OR
1. Resume from checkpoint (@[execute-plan.md] .planning/phases/XX-name/.continue-here-02-01.md)
   OR
1. Execute next plan (@[execute-plan.md] .planning/phases/XX-name/02-02-PLAN.md)
   OR
